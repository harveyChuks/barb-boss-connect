    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              <div>
                ...
                <div className="mt-3 sm:mt-4 h-10 sm:h-12 md:h-14 lg:h-16 overflow-hidden">
                  <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-primary transition-all duration-500 ease-in-out">
                    {animatedText}
                  </h2>
                </div>
                <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mt-4 sm:mt-6 max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">4.9/5 from 500+ business owners</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 sm:py-16 px-4 bg-accent/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-muted-foreground font-medium tracking-wider uppercase">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4">
              The Complete Business Solution You Need to <span className="text-primary block sm:inline">{animatedText}</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 lg:order-2">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-4">
                <QrCode className="h-6 w-6 sm:h-8 sm:w-8 text-primary flex-shrink-0" />
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground">
