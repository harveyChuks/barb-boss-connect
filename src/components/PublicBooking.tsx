                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="text-right">
                        {service.price && (
                          <div className="text-[#39FF14] font-semibold">${service.price}</div>
                        )}
                      ...
                      return (
                        <button
                          ...
                          className={`
                            ...
                            ${isSelected ? 'bg-[#39FF14] text-black font-semibold' : ''}
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {timeSlots.map((time) => (
                        <Button
                          ...
                          className={
                            selectedTime === time
                              ? "bg-[#39FF14] hover:bg-[#32E512] text-black font-medium"
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#39FF14] hover:bg-[#32E512] text-black font-semibold"
                >
